...
// Import entire Three.js namespace
import * as THREE from 'three'
import './GLTFLoader'
import './postprocessing/EffectComposer'

// An object that can be used with a Phaser scene to render 3d content using three.js
...
// Expose Phaser3D for use in other modules
export default Phaser3D
